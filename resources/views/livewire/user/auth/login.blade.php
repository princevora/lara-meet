<div class="min-h-screen flex items-center justify-center">
    <form wire:submit="login" class="w-full max-w-md mx-auto p-6 bg-gray-800 rounded-lg shadow-lg">
        <h1 class="text-xl text-gray-200 text-center m-2 py-2">Login Here</h1>
        <div class="mb-5">
        ...
        <div class="mb-5">
            ...
            <input wire:model="password" placeholder="Enter Your Password Here.." type="password" id="password" value="{{ old('password') }}"
                class="shadow-xs bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 placeholder-gray-400"
                required />
            @error('password')
                <p class="mt-2 text-xs text-red-600 dark:text-red-400">
        ...
        <div class="flex items-center my-5">
            <input wire:model="remember_me" id="checked-checkbox" type="checkbox" value=""
