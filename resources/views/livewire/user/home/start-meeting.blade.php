...
<div class="text-center">
    <button wire:loading.attr='diabled' id="dropdownInformationButton" data-dropdown-toggle="dropdownInformation"
    ...
    <div id="dropdownInformation"
        ...
        <ul class="py-2 bg-gray-900 text-sm text-gray-200"
            ...
            <li class="bg-gray-900">
                <a href="#" wire:click.prevent='startMeeting'
                    ...
                    <div wire:loading wire:target='startMeeting' role="status">
